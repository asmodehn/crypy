"""
Async Kraken.com cryptocurrency Exchange API.
Freely inspired from https://github.com/veox/python3-krakenex and https://github.com/dominiktraxl/pykrakenapi
"""
...
class API(object):
    ...
    def __init__(self, key='', secret=''):
        ...
        self.session.headers.update({
            'User-Agent': 'krakask/' + version.__version__ + ' (+' + version.__url__ + ')'
        })
        self.response = None
        self._json_options = {}
        return
...
if __name__ == '__main__':
    ...
    dt, unixtime = kraken.get_server_time()
    print("Server Time:")
    print(dt)
    print(unixtime)
