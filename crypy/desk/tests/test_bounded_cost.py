...
@given(bp=bounded_cost.BoundedCost.strategy())
...
@given(
    bp1=bounded_cost.BoundedCost.strategy(),
    bp2=bounded_cost.BoundedCost.strategy(),
    bp3=bounded_cost.BoundedCost.strategy(),
)
@settings(verbosity=Verbosity.verbose)
