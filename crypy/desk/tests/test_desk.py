...
class TestOrder(unittest.TestCase):
    ...
    class fakeConfigToMakeDeskHappy:
        def __init__(self, section):
            self.sections = {'testnet.bitmex': section}  # TODO : we shouldnt even need to hardcode a magic string here...
    ...
    def test_balance(self):
        for msg, exchange_section in params:
            with self.subTest(msg = msg, exchange_section = None):
                ...
                assert desk.balance.used
                assert desk.balance.total
